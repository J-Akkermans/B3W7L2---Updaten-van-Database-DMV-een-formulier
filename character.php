        ...
        <div class="detail">
            <div class="left">
                ...
                <div class="stats" style="background-color: <?php echo $CharData['color']; ?>">
                    <ul class="fa-ul">
                        <li><span class="fa-li"><i class="fas fa-heart"></i></span> <?php echo $CharData['health']; ?>
                        </li>
                        <li><span class="fa-li"><i class="fas fa-fist-raised"></i></span>
                            <?php echo $CharData['attack']; ?></li>
                        <li><span class="fa-li"><i class="fas fa-shield-alt"></i></span>
                            <?php echo $CharData['defense']; ?></li>
                    </ul>
                    <ul class="gear">
